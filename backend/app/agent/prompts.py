    ...
    return [
        {
            ...
            "content": (
                ...
                "code, and cite a document only by the short evidence_ref handle "
                "shown on it (for example doc1). Copy that handle exactly and never "
                "write any other identifier in evidence_refs. Do not invent a "
